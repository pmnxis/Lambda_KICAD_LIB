...
def makeIdcHeaderCustom(rows, cols, rm, coldist, body_width, overlen_top, overlen_bottom, body_offset, ddrill, pad,
    ...
    if custom_3d == "":
        ...
        kicad_modg.append(Model(filename="{0}/{1}.3dshapes/{2}".format(model3d_path_prefix, lib_name, custom_3d), at=offset3d, scale=scale3d, rotate=rotate3d))
