...
orientation = 'RV'
number_of_rows = 1
datasheet = 'https://www.molex.com/pdm_docs/sd/530150410_sd.pdf'

# 53015-02 ~ 53015-15
pins_per_row_range = range(2, 16)

part_code = "53015-{n:02}00"
...
stp_dir = '${LAMBDA_LIB_DIR}/3DShapes/Connector_Extended_Molex_53015.3dshapes/'
stp_name = "53015{n:02}10.stp"
...
def generate_one_footprint(pins_per_row, configuration):
   ...
   # model3d_path_prefix = configuration.get('3d_model_prefix','${KICAD6_3DMODEL_DIR}/')
    ...
    model_data = Model(filename=model_path, offset=[(0.4+((pins_per_row-2)*pitch/2)), -2.05, 2.35], scale=[1,1,1], rotate=[-90, 0, 0])
